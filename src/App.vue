<template>
  <v-app id="inspire">
     ...
     app>
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title class="title">Pricing Rules</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      ...
      <v-list
        ...
        nav
      >
        <v-list-item v-for="x in items"  :key="x.title"  :to="x.to" link>
            <v-list-item-icon>  <v-icon>{{ x.icon }}</v-icon> </v-list-item-icon>
            <v-list-item-content>
